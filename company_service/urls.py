...
production_line_router.register('stops', views.ProductionLineStopViewSet, 'companies-production_lines-stops')
production_line_router.register('pending_stops', views.ProductionLinePendingStopViewSet, 'companies-production_lines-pending_stops')
