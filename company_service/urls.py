...
production_line_router.register('stops', views.ProductionLineStopViewSet, base_name='companies-production_lines-stops')
production_line_router.register('pending_stops', views.ProductionLinePendingStopViewSet, base_name='companies-production_lines-pending_stops')
