...
companies_router.register('availability_chart', views.AvailabilityChartViewSet, basename='companies-availability_chart')
companies_router.register('production_chart', views.ProductionChartViewSet, basename='companies-production_chart')
companies_router.register('reject_chart', views.RejectChartViewSet, basename='companies-reject_chart')
...
turn_schemes_router.register('turns', views.TurnViewSet, basename='companies-turn_schemes-turns')
...
production_line_router.register('stops', views.ProductionLineStopViewSet, basename='companies-production_lines-stops')
production_line_router.register('pending_stops', views.ProductionLinePendingStopViewSet, basename='companies-production_lines-pending_stops')
