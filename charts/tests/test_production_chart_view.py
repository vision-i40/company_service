...
class ProductionChartTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.production_events = [
            ...
            self.create_production_event(ProductionEvent.PRODUCTION, 47, self.first_production_order, datetime.datetime(2019, 12, 26, 10, 15, 5, 940070, tzinfo=pytz.UTC).strftime(self.test_date_format)),
            self.create_production_event(ProductionEvent.PRODUCTION, 32, self.first_production_order, datetime.datetime(2019, 12, 26, 10, 59, 15, 940070, tzinfo=pytz.UTC).strftime(self.test_date_format)),
        ]
